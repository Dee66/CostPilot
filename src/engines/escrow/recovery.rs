...
use crate::engines::escrow::package::{BuildVerification, EscrowPackage};
...
impl RecoveryPlaybook {
    ...
    pub fn generate(&self) -> String {
        ...
        playbook.push_str(
            "This playbook guides you through recovering CostPilot from the escrow package.\n",
        );
        playbook.push_str(
            "Follow each step in order to successfully build and deploy CostPilot from source.\n\n",
        );
...
mod tests {
    ...
    fn test_recovery_report_format() {
        let report = RecoveryReport {
            success: true,
            steps_completed: vec![RecoveryStep {
